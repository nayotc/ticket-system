...
public class Event {
    ...
    public Event(long id, String name, Date date, String location, long trafficThreshold, EventCategory category, EventMap map, PurchasePolicy purchasePolicy, DiscountPolicy discountPolicy) {
        this.id = id;
        this.name = name;
        this.Date = date;
