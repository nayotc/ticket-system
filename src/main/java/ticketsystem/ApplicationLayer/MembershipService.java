...
public class MembershipService {
    ...
    public boolean requestManagerAssignment(String sessionToken, Long companyId, Long targetMemberId, Set<Permission> permissions) throws Exception {
        ...
        try {
            ...
            // Unexpected system errors
            logger.logError("Unexpected system error in requestManagerAssignment. " + context + ". reason=" + e.getMessage(), e);
            throw new RuntimeException(
                "An error occurred while requesting manager assignment: " + e.getMessage(), e);
        }
    }
    ...
    public boolean requestOwnerAssignment(String sessionToken, Long companyId, Long targetMemberId) throws Exception {
        ...
        try {
            ...
            if (!membershipDomain.ownerAssignmentRequest(appointer, targetMember, companyId)) {
                logger.logEvent("Failed - requestOwnerAssignment. Domain logic rejected the request. " + context, LogLevel.WARN);
                return false;
            }
            ...
            // Unexpected system errors
            logger.logError("Unexpected system error in requestOwnerAssignment. " + context + ". reason=" + e.getMessage(), e);
            throw new RuntimeException(
                "An error occurred while requesting owner assignment: " + e.getMessage(), e);
        }
    }
    ...
    public boolean approveAssignment(String sessionToken, Long companyId) throws Exception {
        ...
        try {
            ...
            // Unexpected system errors
            logger.logError("Unexpected system error in approveAssignment. " + context + ". reason=" + e.getMessage(), e);
            throw new RuntimeException(
                "An error occurred while approving assignment: " + e.getMessage(), e);
        }
    }
    ...
    public boolean rejectAssignment(String sessionToken, Long companyId) throws Exception {
        ...
        try {
            ...
            // Unexpected system errors
            logger.logError("Unexpected system error in rejectAssignment. " + context + ". reason=" + e.getMessage(), e);
            throw new RuntimeException(
                "An error occurred while rejecting assignment: " + e.getMessage(), e);
        }
    }
