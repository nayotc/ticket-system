...
public class WaitingQueuePresenter implements WaitingQueue.WaitingQueuePresenter {
    ...
    public void leaveQueue(long eventId, String sessionToken) {
        try {
            ...
            throw PresentationException.dispatch(e, msg -> translateQueueError(msg != null ? msg : "לא ניתן לצאת מהתור כרגע."));
        }
    }
    ...
    public long getSelectionAccessSecondsLeft(long eventId, String sessionToken) {
        try {
            ...
            throw PresentationException.dispatch(e, msg -> translateQueueError(msg != null ? msg : "לא ניתן לטעון את זמן הגישה לבחירת הכרטיסים."));
        }
    }
    ...
    public boolean expireSelectionAccessIfNeeded(long eventId, String sessionToken) {
        try {
            ...
            throw PresentationException.dispatch(e, msg -> translateQueueError(msg != null ? msg : "לא ניתן לבדוק את תוקף הגישה לבחירת הכרטיסים."));
        }
    }
