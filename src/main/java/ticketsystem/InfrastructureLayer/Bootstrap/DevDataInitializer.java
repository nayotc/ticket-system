...
public class DevDataInitializer implements CommandLineRunner {
    ...
    private void createTestSalesData() {
        ...
        OrderDTO order1 = new OrderDTO(8492L, List.of(ticket1, ticket2), "פסטיבל אורות הלילה", "תל אביב", buyerId, getTestCompanyId(), founderId, 91L, new BigDecimal(180), 111111,false);
