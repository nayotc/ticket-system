...
public class DevDataInitializer implements CommandLineRunner {
    ...
    private void createTestSalesData() {
        ...
        OrderDTO order1 = new OrderDTO(8492L, List.of(ticket1, ticket2), "פסטיבל אורות הלילה", "תל אביב", buyerId, TEST_COMPANY_ID, founderId, 91L, new BigDecimal(360), 111111,false);
        ...
        OrderDTO order2 = new OrderDTO(8491L, List.of(ticket3), "הופעת רוק במדבר", "באר שבע", buyerId, TEST_COMPANY_ID, founderId, 92L, new BigDecimal(120), 222222,false);
        ...
        OrderDTO order3 = new OrderDTO(8493L, List.of(ticket4, ticket5), "פסטיבל שקיעה", "תל אביב", buyerId, TEST_COMPANY_ID, ownerId, 101L, new BigDecimal(300),111111,false);
        ...
        OrderDTO order4 = new OrderDTO(8494L, List.of(ticket6), "הופעת ג'אז", "באר שבע", buyerId, TEST_COMPANY_ID, ownerId, 102L, new BigDecimal(200), 111111,false);
